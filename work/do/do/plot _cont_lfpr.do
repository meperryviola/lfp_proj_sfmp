...
twoway (hist ftotval if ftotval<200000, bcolor(blue%20) width(10000)) (hist unlog_phat_ftotval if unlog_phat_ftotval<200000, bcolor(red%20) width(10000))

twoway (hist ftotval if ftotval<25000 & ftotval>-999, bcolor(blue%20) width(1000)) (hist unlog_phat_ftotval if unlog_phat_ftotval<25000, bcolor(red%20) width(1000))
*********** For Basic *****************
