...
mi impute monotone (pmm, knn(3)) fearnval ftotval fam_agi  = i.race i.educ i.sex i.hefaminc c.numkid i.spousemp, add(5) rseed(4409) by(marital) force

save mono_imputed_`x', replace
}
